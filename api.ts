...
export const EmailApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getEmail: async (email: string, password: string, folder: string, timeout: number, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v1/email/mail/{email}/{password}/{folder}/{timeout}`
        ...
        getInboxFolders: async (email: string, password: string, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v1/email/folders/{email}/{password}`
                .replace(`{${"email"}}`, encodeURIComponent(String(email)))
                .replace(`{${"password"}}`, encodeURIComponent(String(password)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
        ...
        getUnseen: async (email: string, password: string, limit: number, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v1/email/unseen/{email}/{password}/{limit}`
                .replace(`{${"email"}}`, encodeURIComponent(String(email)))
                .replace(`{${"password"}}`, encodeURIComponent(String(password)))
...
export const EmailApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getEmail(email: string, password: string, folder: string, timeout: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AnyType>> {
         ...
         * @throws {RequiredError}
         */
        async getInboxFolders(email: string, password: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AnyType>> {
         ...
         * @throws {RequiredError}
         */
        async getUnseen(email: string, password: string, limit: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AnyType>> {
...
export const EmailApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getEmail(email: string, password: string, folder: string, timeout: number, options?: any): AxiosPromise<AnyType> {
         ...
         * @throws {RequiredError}
         */
        getInboxFolders(email: string, password: string, options?: any): AxiosPromise<AnyType> {
         ...
         * @throws {RequiredError}
         */
        getUnseen(email: string, password: string, limit: number, options?: any): AxiosPromise<AnyType> {
...
export const InboxApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createInbox: async (email: string, password: string, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/v1/inbox/{email}/{password}`
                .replace(`{${"email"}}`, encodeURIComponent(String(email)))
                .replace(`{${"password"}}`, encodeURIComponent(String(password)));
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
        ...
        getInboxesList: async (options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v1/inbox/inboxes`;
            const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const InboxApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async createInbox(email: string, password: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AnyType>> {
         ...
         * @throws {RequiredError}
         */
        async createRandomInbox(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AnyType>> {
         ...
         * @throws {RequiredError}
         */
        async getInboxesList(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AnyType>> {
...
export const InboxApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        createInbox(email: string, password: string, options?: any): AxiosPromise<AnyType> {
         ...
         * @throws {RequiredError}
         */
        createRandomInbox(options?: any): AxiosPromise<AnyType> {
         ...
         * @throws {RequiredError}
         */
        getInboxesList(options?: any): AxiosPromise<AnyType> {
...
export const JobsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getJobResult(jobId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AnyType>> {
...
export const JobsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getJobResult(jobId: string, options?: any): AxiosPromise<AnyType> {
